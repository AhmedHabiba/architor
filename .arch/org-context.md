...
> The more detail you provide, the more relevant the AI's recommendations will be.
> Delete these instruction lines after filling in.
...
## Past Architecture Decisions — Lessons Learned

> List past architecture decisions that went well or badly.
> This helps the AI avoid repeating mistakes.
...
- **[Year/Quarter]:** [What happened, what was learned]
  ...
  - e.g., 2024 Q3: Microservices for a 4-person team. Excessive overhead. Consolidated to modular monolith successfully.
